...
It is designed to be extremely easy to program and ultrafast for serializing common data structures in high performance computing, which are usually highly structured and homogeneous.
