...
This design makes the binding of data and serialization methods more cohesive and can often give a much cleaner design than serialization libraries based on schema files.
